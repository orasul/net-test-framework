...
def index(request):
  ...
  return render_to_response(os.getcwd() + '/index.pt', {'host_table':l}, request=request)

def add_host_form(request):
  return render_to_response(os.getcwd() + '/add_host.pt', {}, request=request)
...
def add_host_apply(request):
  ...
  return render_to_response(os.getcwd() + '/add_host_apply.pt', { 'created' : json_str, 'cwd' : os.getcwd() }, request=request)
...
def edit_host(request):
  ...
  return render_to_response(os.getcwd() + '/edit_host.pt', json_dict, request=request)
...
def add_test_form(request):
  ...
  return render_to_response(os.getcwd() + '/add_test.pt', {'hosts': l, "routing_table_tests": routing_table_tests, "interfaces_tests": interfaces_tests, "service_tests": service_tests, "code": json.dumps(d)}, request=request)
...
def add_test_apply(request):
  ...
  return render_to_response(os.getcwd() + '/add_test_apply.pt', { 'created' : json_str, 'cwd' : os.getcwd() }, request=request)
...
def edit_test(request):
  ...
  return render_to_response(os.getcwd() + '/edit_test.pt', json_dict, request=request)

def run_tests(request):
  from head import result
  l=str(head.result)
  return render_to_response(os.getcwd() + '/run_tests.pt', { 'tests' : l }, request=request)
